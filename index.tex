...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, bottomrule=.15mm, titlerule=0mm, arc=.35mm, bottomtitle=1mm, breakable, coltitle=black, toprule=.15mm, opacitybacktitle=0.6, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, left=2mm, opacityback=0, colback=white, colframe=quarto-callout-note-color-frame]
