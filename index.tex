...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, left=2mm, colback=white, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, breakable, rightrule=.15mm, toptitle=1mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacityback=0, leftrule=.75mm, toprule=.15mm]
