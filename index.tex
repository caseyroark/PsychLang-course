...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colback=white, bottomtitle=1mm, coltitle=black, left=2mm, bottomrule=.15mm, arc=.35mm, breakable, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, toptitle=1mm, leftrule=.75mm, rightrule=.15mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacityback=0]
...
\addcontentsline{toc}{subsection}{Confidentiality and Mandatory
Reporting of Sexual Violence or Harassment}
...
\addcontentsline{toc}{subsection}{Credit Hours}
...
\addcontentsline{toc}{subsection}{NameCoach}
...
\addcontentsline{toc}{subsection}{Curtailed Operations}
...
\addcontentsline{toc}{section}{General well-being and stress}

\markright{General well-being and stress}
...
\addcontentsline{toc}{section}{General resources}

\markright{General resources}
...
\addcontentsline{toc}{subsection}{Center for Academic Resources (CFAR)}
...
\addcontentsline{toc}{subsection}{Knack}
...
\addcontentsline{toc}{subsection}{Early Alert Progress Report}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2911}}
