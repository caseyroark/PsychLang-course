...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, rightrule=.15mm, opacityback=0, toprule=.15mm, coltitle=black, toptitle=1mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, breakable, bottomtitle=1mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm, colback=white, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, titlerule=0mm]
